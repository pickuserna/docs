...
{
	var unit_id     = "1842599";
	var client_ip   = "101.226.178.74";
	var server_time = "1414655689";
	var verify_code = "7f316b64";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/1842599/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
